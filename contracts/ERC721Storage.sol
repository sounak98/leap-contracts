...
contract ERC721Storage {
  ...
  // Mapping from token ID to storage root
  mapping (uint256 => bytes32) internal storageRoot;
  ...
  function getMerkleRoot(bytes32 _leaf, uint256 _index, bytes32[] _proof) internal pure returns (bytes32) {
